class UI extends Phaser.Scene {
    ...
    create() {
        ...
        this.registry.events.on('game_over', () => {
            ...
            this.scene.start('GameOverScene', {points: this.actual_points});
        ...
        //Si registra el evento restart, se reinicia el juego
        this.registry.events.on('restart', () => {
            this.registry.events.removeAllListeners();
            this.scene.start('Play');
        });
        //si entra el evento exit se vaya al menu principal
        this.registry.events.on('exit', () => {
            this.registry.events.removeAllListeners();
